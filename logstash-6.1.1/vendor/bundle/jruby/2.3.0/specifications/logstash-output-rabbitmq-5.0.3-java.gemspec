# -*- encoding: utf-8 -*-
# stub: logstash-output-rabbitmq 5.0.3 java lib

Gem::Specification.new do |s|
  s.name = "logstash-output-rabbitmq".freeze
  s.version = "5.0.3"
  ...
  s.summary = "Pushes events to a RabbitMQ exchange".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-rabbitmq_connection>.freeze, ["< 6.0.0", ">= 5.0.0"])
      ...
      s.add_dependency(%q<logstash-mixin-rabbitmq_connection>.freeze, ["< 6.0.0", ">= 5.0.0"])
