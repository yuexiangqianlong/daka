# -*- encoding: utf-8 -*-
# stub: logstash-output-kafka 7.0.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.requirements = ["jar 'org.apache.kafka:kafka-clients', '0.11.0.0'".freeze, "jar 'org.slf4j:slf4j-log4j12', '1.7.21'".freeze, "jar 'org.apache.logging.log4j:log4j-1.2-api', '2.6.2'".freeze]
  s.rubygems_version = "2.6.13".freeze
  s.summary = "Output events to a Kafka topic. This uses the Kafka Producer API to write messages to a topic on the broker".freeze
