# -*- encoding: utf-8 -*-
# stub: logstash-input-kafka 8.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.requirements = ["jar 'org.apache.kafka:kafka-clients', '0.11.0.0'".freeze, "jar 'org.apache.logging.log4j:log4j-slf4j-impl', '2.8.2'".freeze]
  s.rubygems_version = "2.6.13".freeze
  s.summary = "This input will read events from a Kafka topic. It uses the high level consumer API provided by Kafka to read messages from the broker".freeze
