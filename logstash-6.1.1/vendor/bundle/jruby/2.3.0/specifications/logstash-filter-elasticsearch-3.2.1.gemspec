# -*- encoding: utf-8 -*-
# stub: logstash-filter-elasticsearch 3.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<elasticsearch>.freeze, ["< 6.0.0", ">= 5.0.3"])
      s.add_development_dependency(%q<logstash-devutils>.freeze, [">= 0"])
    else
      s.add_dependency(%q<logstash-core-plugin-api>.freeze, ["<= 2.99", ">= 1.60"])
      s.add_dependency(%q<elasticsearch>.freeze, ["< 6.0.0", ">= 5.0.3"])
